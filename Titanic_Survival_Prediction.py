...
with tab2:
    ...
    with col4:
        ...
        ax[1].set_ylabel('Quantity')
        st.pyplot(f)
        par0 = train[train['Parents_Children_On_Board'] == 0]['Survived'].eq('Yes').mean()
        par1 = train[train['Parents_Children_On_Board'] == 1]['Survived'].eq('Yes').mean()
        par2 = train[train['Parents_Children_On_Board'] == 2]['Survived'].eq('Yes').mean()
        par3 = train[train['Parents_Children_On_Board'] == 3]['Survived'].eq('Yes').mean()
        par4 = train[train['Parents_Children_On_Board'] == 4]['Survived'].eq('Yes').mean()
        par5 = train[train['Parents_Children_On_Board'] >= 5]['Survived'].eq('Yes').mean()
